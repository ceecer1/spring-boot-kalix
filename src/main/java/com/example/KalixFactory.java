...
import com.example.deal.action.base.DealTopicServiceActionProvider;
...
public final class KalixFactory {
  ...
  public static Kalix withComponents(
      ...
      Function<ActionCreationContext, DealTopicServiceAction> createDealTopicServiceAction,
    ...
    return kalix
      ...
      .register(DealTopicServiceActionProvider.of(createDealTopicServiceAction))
